...
OFILES = game/entity.c game/monsters.c game/state.c graphics/draw.c graphics/font.c graphics/gba.c images/death/dead.c images/geralt/geralt.c images/monsters/werewolf/werewolf.c images/startScreen/startScreen.c main.c utils/rand.c
