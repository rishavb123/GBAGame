...
OFILES = game/entity.c game/state.c graphics/draw.c graphics/font.c graphics/gba.c images/geralt/geralt.c images/startScreen/startScreen.c main.c utils/rand.c
